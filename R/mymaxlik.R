...
#'
#' This will display the graph for the max likelihood (binomial)
#'
#' @param lfun the function that is being used for the graph
#' @param x sample values
#' @param param the parameter
#' @param ... anything else needed for the binom graph
#'
