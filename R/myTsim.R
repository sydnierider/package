#' Sampling distributions from the T distribution
#'
#' This will display the graph and p-value of a certain t0.
#'
#' @param n1 sample value
#' @param sigma1 the sigma value
#' @param mean1 the mean of the value
#' @param iter iteration value
#' @param ymax max y value on hisogram
#' @param ... cont of the histogram if needed
#'
